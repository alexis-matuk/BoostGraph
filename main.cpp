...
//    bool Directed = false;
//    bool done = false;
//    std::cout << "Qué tipo de grafo quieres implementar: \n1) Grafo dirigido\n2) Grafo no dirigido\nElige una opción: ";
//    while(!(std::cin >> graphType)){
//        std::cin.clear();
...
//            std::cout << "Al tener un grafo dirigido, puede ser que los algoritmos nos funcionen de la manera más óptima posible" << std::endl;
...
//                    if(vertexExists(g, v, posv))
//                    {
//                        boost::dijkstra_shortest_paths(g, posv, boost::predecessor_map(&parents[posv]).distance_map(&distances[posv]));
